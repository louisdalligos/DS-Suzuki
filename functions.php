<?php
/**
 * ds-suzuki functions and definitions
 *
...
if ( ! function_exists( 'ds_suzuki_setup' ) ) :
/**
 ...
 */
function ds_suzuki_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on ds-suzuki, use a find and replace
	 * to change 'ds-suzuki' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'ds-suzuki', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Header', 'ds-suzuki' ),
		'menu-2' => esc_html__( 'Footer', 'ds-suzuki' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'ds_suzuki_custom_background_args', array(
...
add_action( 'after_setup_theme', 'ds_suzuki_setup' );
 ...
 */
function ds_suzuki_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'ds_suzuki_content_width', 640 );
}
add_action( 'after_setup_theme', 'ds_suzuki_content_width', 0 );
 ...
 */
function ds_suzuki_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'ds-suzuki' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'ds-suzuki' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Widgets', 'ds-suzuki' ),
		'id'            => 'footer-widget-up',
		'description'   => esc_html__( 'Add widgets here.', 'ds-suzuki' ),
...
add_action( 'widgets_init', 'ds_suzuki_widgets_init' );
...
function ds_suzuki_scripts() {
	...
	wp_enqueue_script( 'equal-height', get_template_directory_uri() . '/js/jquery.equalheight.min.js', array(), '20151215', true );
...
add_action( 'wp_enqueue_scripts', 'ds_suzuki_scripts' );
